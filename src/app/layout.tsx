...
const CROSS_NAV = [
  ...
  { label: "CLI", subdomain: "cli" as const, href: SUBDOMAINS.mcp },
  { label: "CLI", subdomain: "cli" as const, href: SUBDOMAINS.cli },
];

export const metadata = {
  title: "AgeZero CLI",
  description: "Standalone CLI for the AgeZero UI kit. Install components by slug, zero runtime deps.",
};
    ...
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-50 w-full border-b border-border/60 bg-background/80 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-7xl items-center gap-3 px-4 sm:px-6">
          ...
          <a href="https://github.com/pathtoresiliencebv/agezero-ui/tree/main/packages/agezero-cli" target="_blank" rel="noreferrer" className="ml-auto text-xs text-muted-foreground hover:text-foreground">
            GitHub
          </a>
        </div>
      </header>
